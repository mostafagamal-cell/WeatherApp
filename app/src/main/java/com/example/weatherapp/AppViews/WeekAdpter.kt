...
class WeekAdpter: ListAdapter<List, WeekAdpter.VH, >(object : DiffUtil.ItemCallback<List>() {
    ...
    class VH(val itemTimeBinding: ItemdailyBinding) : RecyclerView.ViewHolder(itemTimeBinding.root) {
        fun bind(list: List) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        return VH(ItemdailyBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
